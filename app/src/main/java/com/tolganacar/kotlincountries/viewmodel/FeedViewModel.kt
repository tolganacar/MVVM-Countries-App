...
import com.tolganacar.kotlincountries.service.CountryAPIService
import com.tolganacar.kotlincountries.service.CountryDatabase
import com.tolganacar.kotlincountries.util.CustomSharedPreferences
...
class FeedViewModel(application: Application) : BaseViewModel(application) {
    ...
    private var refrestTime = 10 * 60 * 1000* 1000 * 1000L
